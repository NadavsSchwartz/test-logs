...
>(({ children, align = 'end', ...props }, forwardedRef) => {
  return (
    <DropdownMenuPrimitive.Content
      align={align}
      {...props}
      className="shadow-dropdown w-50 relative z-10 mt-1 -ml-0 origin-top-right rounded-md border border-gray-200 bg-white text-sm rounded-md"
      ref={forwardedRef}
    >
      {children}
    </DropdownMenuPrimitive.Content>
...
>(({ className = '', ...props }, forwardedRef) => (
  <DropdownMenuPrimitive.Item
    className={`focus:ring-brand-800 text-sm text-gray-700 ring-inset first-of-type:rounded-t-[inherit] last-of-type:rounded-b-[inherit] hover:bg-gray-100 hover:text-gray-900 focus:outline-none rounded-md focus:ring-1 ${className}`}
    {...props}
    ref={forwardedRef}
  />
));
